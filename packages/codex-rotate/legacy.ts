#!/usr/bin/env bun
/**
 * Legacy TypeScript codex-rotate entrypoint.
 *
 * This stays in place for commands that still rely on the existing TS service
 * implementation while the public index.ts becomes a thin Rust CLI wrapper.
 */
